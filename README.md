...
| 参数 | 说明 | 取值范围 |
|------|------|----------|
| **层级得分** | 该层级内四个维度（代码、架构、数理、可视化）得分总和 | 0-40 分/层 |
| **层级权重** | 难度越高权重越大 | L1:1.0, L2:1.2, L3:1.5, L4:2.0 |
| **AI系数 (γ_AI)** | 审计学生对 AI 的使用程度 | 0.0 ~ 1.2 |
...
- L1: (10+10+10+10) × 1.0 = **40**
- L2: (8+8+6+10) × 1.2 = **38.4**
- L3: (0+0+0+8) × 1.5 = **12**
- L4: 0
- 基础总分: 90.4
- AI 系数: 1.05 (理解 AI 代码，略偏上)
- **最终得分: 90.4 × 1.05 = 94.92**
